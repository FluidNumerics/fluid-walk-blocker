...
__version__ = '@@VERSION@@'  # GENERATED from VERSION
...
# CLI surface.
DEFAULT_PREFIX = '@@install.prefix@@'  # GENERATED from site.toml:install.prefix
DEFAULT_UNIT_DIR = '@@install.unit_dir@@'  # GENERATED from site.toml:install.unit_dir
DEFAULT_SPOOL_DIR = '@@install.spool_dir@@'  # GENERATED from site.toml:install.spool_dir
DEFAULT_AUDIT_FILENAME = '@@install.audit_filename@@'  # GENERATED from site.toml:install.audit_filename
...
DEFAULT_BASHRC_FILE = '@@hooks.bash.file@@'  # GENERATED from site.toml:hooks.bash.file
HOOK_ENABLED_BASH = '@@hooks.bash.enabled@@'  # GENERATED from site.toml:hooks.bash.enabled
DEFAULT_ZSHENV_FILE = '@@hooks.zsh.file@@'  # GENERATED from site.toml:hooks.zsh.file
HOOK_ENABLED_ZSH = '@@hooks.zsh.enabled@@'  # GENERATED from site.toml:hooks.zsh.enabled
DEFAULT_FISH_CONF_FILE = '@@hooks.fish.file@@'  # GENERATED from site.toml:hooks.fish.file
HOOK_ENABLED_FISH = '@@hooks.fish.enabled@@'  # GENERATED from site.toml:hooks.fish.enabled
...
TIMER_SLOT = '@@timer.on_calendar@@'  # GENERATED from site.toml:timer.on_calendar
TIMER_RANDOMIZED_DELAY_SEC = '@@timer.randomized_delay_sec@@'  # GENERATED from site.toml:timer.randomized_delay_sec
TIMER_ACCURACY_SEC = '@@timer.accuracy_sec@@'  # GENERATED from site.toml:timer.accuracy_sec
TIMER_PERSISTENT = '@@timer.persistent@@'  # GENERATED from site.toml:timer.persistent
...
TIMEOUT_START_SEC = '@@timer.timeout_start_sec@@'  # GENERATED from site.toml:timer.timeout_start_sec
RELINK_TIMEOUT_S = '@@timer.relink_timeout_s@@'  # GENERATED from site.toml:timer.relink_timeout_s
RELINK_KILL_AFTER_S = '@@timer.relink_kill_after_s@@'  # GENERATED from site.toml:timer.relink_kill_after_s
...
TRUSTED_TIMEOUT = '@@trusted_binaries.timeout@@'  # GENERATED from site.toml:trusted_binaries.timeout
TRUSTED_SH = '@@trusted_binaries.sh@@'  # GENERATED from site.toml:trusted_binaries.sh
TRUSTED_PYTHON3 = '@@trusted_binaries.python3@@'  # GENERATED from site.toml:trusted_binaries.python3
...
INSTALLED_ENTRIES = ("reaper.py", "search_rules.py", "survey.py", "walk-job",
                     "shim", "docs", "README.md", "LICENSE", "site.toml",
                     "site.lock.json", PAYLOAD_MARKER)
