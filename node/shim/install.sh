...
DEFAULT_TOOL_PATH='@@install.tool_search_path@@'  # GENERATED from site.toml:install.tool_search_path[:]
...
BASHRC_FILE='@@hooks.bash.file@@'  # GENERATED from site.toml:hooks.bash.file
BASH_HOOK_PACKAGE='@@hooks.bash.package@@'  # GENERATED from site.toml:hooks.bash.package
BASH_HOOK_ENABLED='@@hooks.bash.enabled@@'  # GENERATED from site.toml:hooks.bash.enabled
BASH_HOOK_GATE='@@hooks.bash.gate@@'  # GENERATED from site.toml:hooks.bash.gate
ZSHENV_FILE='@@hooks.zsh.file@@'  # GENERATED from site.toml:hooks.zsh.file
ZSH_HOOK_PACKAGE='@@hooks.zsh.package@@'  # GENERATED from site.toml:hooks.zsh.package
ZSH_HOOK_ENABLED='@@hooks.zsh.enabled@@'  # GENERATED from site.toml:hooks.zsh.enabled
ZSH_HOOK_GATE='@@hooks.zsh.gate@@'  # GENERATED from site.toml:hooks.zsh.gate
FISH_CONF_FILE='@@hooks.fish.file@@'  # GENERATED from site.toml:hooks.fish.file
FISH_HOOK_ENABLED='@@hooks.fish.enabled@@'  # GENERATED from site.toml:hooks.fish.enabled
FISH_HOOK_GATE='@@hooks.fish.gate@@'  # GENERATED from site.toml:hooks.fish.gate
...
SG_MOUNT_TABLE='@@filesystems.mount_table@@'  # GENERATED from site.toml:filesystems.mount_table
SG_REMOTE_FSTYPES='@@filesystems.remote_fstypes@@'  # GENERATED from site.toml:filesystems.remote_fstypes[:]
SG_REMOTE_PROXY='@@filesystems.remote_proxy@@'  # GENERATED from site.toml:filesystems.remote_proxy
...
SG_LOGGER='@@trusted_binaries.logger@@'  # GENERATED from site.toml:trusted_binaries.logger
